...
import { createProduct } from '../../../api/APIs/productApi';
...
const ProductCreate = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    inStock: '',
    videoUrl: '',
    configurations: [{ name: '', description: '' }],
    specifications: [{ name: '', description: '' }],
    contents: [{ title: '', description: '', imageUrl: '' }],
    images: [{ imageUrl: '', main: false }],
  });
    ...
    const formData = new FormData();
        ...
        try {
            ...
            setFormData((prev) => {
                ...
                newImages[index].imageUrl = result.data; // URL trả về từ API
                return { ...prev, images: newImages };
            });
      ...
      if (response.status === 201) {
        ...
        switch (response.status) {
          ...
          case 422:
            ...
            break;
          case 404:
            toast.error('Không tìm thấy danh mục, hãng hoặc thẻ');
            break;
          default:
      ...
      <div className="p-4 sm:ml-64 pt-20">
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-4 border-b-2 border-blue-700 pb-2">
            <h2 className="text-2xl font-bold text-blue-700">THÊM SẢN PHẨM</h2>
