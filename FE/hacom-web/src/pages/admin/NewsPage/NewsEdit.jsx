...
import { getNewsById, updateNews } from '../../../api/APIs/newsApi';
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setFormData({
          ...
          isHighlight: news.highlight === true || news.highlight === 1,
          isActive: news.active === true || news.active === 1,
        });
      } else {
      ...
      <div className="p-4 sm:ml-64 pt-20">
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-4 border-b-2 border-blue-700 pb-2">
            <h2 className="text-2xl font-bold text-blue-700">SỬA TIN TỨC</h2>
            <div className="flex items-center gap-4">
              <nav className="text-sm text-gray-600 flex items-center flex-nowrap">
                ...
                <span className="mx-2">{'>'}</span>
                <span className="font-medium text-gray-800">Sửa</span>
              </nav>
              <button
