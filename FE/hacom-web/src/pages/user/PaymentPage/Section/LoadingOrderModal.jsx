...
const LoadingOrderModal = ({ isOpen, onClose, processOrder }) => {
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[60] bg-black bg-opacity-50">
      <div className="bg-white border border-black rounded-lg p-8 shadow-lg text-center w-[400px]">
        ...
        <h2 className="text-xl font-bold mb-2">Đang xử lý đơn hàng</h2>
...
export default LoadingOrderModal;