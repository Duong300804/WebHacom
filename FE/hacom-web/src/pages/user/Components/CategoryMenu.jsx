...
import { GiPc } from "react-icons/gi"; //PC
import { HiOutlineCpuChip } from "react-icons/hi2"; //Linh kiện
import { PiMonitorBold } from "react-icons/pi"; //màn hình
import { BsUsbMini } from "react-icons/bs"; //phụ kiện
import { PiThermometerCold } from "react-icons/pi"; //tản nhiệt
import { FaRegLightbulb } from "react-icons/fa"; //led
import { IoGameController } from "react-icons/io5"; //gaming gear
import { PiOfficeChair } from "react-icons/pi"; //ghế
import { FaHeadphones } from "react-icons/fa"; //tai nghe
import { FaVolumeUp } from "react-icons/fa"; //loa
import { FaWifi } from "react-icons/fa"; //Thiết bị mạng
...
const CategoryMenu = ({ onClose }) => {
  ...
  return (
    ...
    {/* Menu chính */}
      <div 
        ref={menuRef}
        className="absolute top-full left-0 mt-2 w-56 bg-white border border-gray-300 rounded-lg shadow-lg z-50 overflow-hidden">
      ...
      {hoveredCategory && modalData && (
        <div 
          className="absolute top-full left-[230px] mt-2 bg-white border border-gray-300 rounded-lg shadow-lg z-40 overflow-auto sidebar-scrollbar" 
          style={{ width: 'calc(100vw - 230px)', maxWidth: '1000px', height: '74vh' }}
          onMouseEnter={handleModalHover}
